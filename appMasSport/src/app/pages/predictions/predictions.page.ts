...
export class PredictionsPage implements OnInit, OnDestroy {
  ...
  constructor( 
    private client : ClientService, private predictions : PredictionsService,
    private http : HttpClient, private  router: Router, private loading : LoadingService,
  ...
  dateMatchsLeagues(date){
    if(date === undefined || date === null){
      return "Temporada Finalizada";
       ...
       moment.locale('es');
      return moment(date,'YYYY/MM/DD HH:mm:ss').endOf(date).fromNow();
    }
