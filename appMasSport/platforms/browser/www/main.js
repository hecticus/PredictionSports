...
var map = {
	...
	"./pages/get-password/get-password.module": [
	...
	"./pages/rankings/rankings.module": [
		"./src/app/pages/rankings/rankings.module.ts",
		"common",
		"rankings-rankings-module"
	],
	"./pages/tabs-statistics/tabs.module": [
...
module.exports = "<ion-app>\n  <ion-menu side=\"start\"\n          menuId=\"menuprincipal\"\n          contentId=\"content\">\n    <ion-header>\n      <ion-toolbar color=\"primary\">\n        <ion-title>Menú</ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n        <ion-list>\n          <ion-list-header >\n            <ion-label color=\"primary\" class=\"menu-header\">Predicciones</ion-label>\n          </ion-list-header>\n          <ion-menu-toggle *ngFor=\"let opt of predictions\" >\n            <ion-item  [routerLink]=\"opt.url\">\n              <ion-icon [name]=\"opt.icon\" color=\"primary\"></ion-icon>\n              <ion-label color=\"primary\">{{opt.title}}</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n        <ion-list>\n          <ion-list-header >\n            <ion-label color=\"primary\" class=\"menu-header\">Estadisticas</ion-label>\n          </ion-list-header>\n           <ion-menu-toggle *ngFor=\"let st of statistics\" >\n            <ion-item [routerLink]=\"st.url\">\n              <ion-icon color=\"primary\" [name]=\"st.icon\"></ion-icon>\n              <ion-label color=\"primary\">{{st.title}}</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n        <ion-list>\n          <ion-menu-toggle>\n            <ion-item routerLink=\"/configurations\">\n              <ion-icon color=\"primary\" name=\"settings\"></ion-icon>\n              <ion-label color=\"primary\" class=\"menu-header\">Configuraciones</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n          <ion-menu-toggle>\n            <ion-item (click)=\"logOut()\">\n              <ion-icon color=\"primary\" name=\"close-circle-outline\"></ion-icon>\n              <ion-label color=\"primary\" class=\"menu-header\">Cerrar Sesion</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n  </ion-menu>\n  <ion-router-outlet id=\"content\" main></ion-router-outlet>\n</ion-app>"
...
/* harmony import */ var _services_configurations_configurations_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/configurations/configurations.service */ "./src/app/services/configurations/configurations.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, router, loading, ionRouter, config) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationEnd"]) {
                _this.predictions.map(function (p) {
    ...
    AppComponent.prototype.inStatistics = function () {
        var _this = this;
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationEnd"]) {
                _this.statistics.map(function (p) {
                    return p['active'] = (event.url === p.url);
                });
            }
        });
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            document.addEventListener("backbutton", function () {
                if (_this.router.url === '/tabs-statistics/live' || _this.router.url === '/tabs-statistics/matches' || _this.router.url === '/tabs/news' || _this.router.url === '/tabs/rankings' || _this.router.url === '/tabs/my-points') {
                    _this.loading.presentAlertConfirm('Alerta', '', '¿Estás seguro que quieres salir de la aplicación?', [
                        {
                            text: 'Cancelar',
                            handler: function () {
                                console.log('Cancel');
        ...
        this.platform.pause.subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.session = false;
                console.log("pasó a segundo plano ");
                return [2 /*return*/];
            });
        }); });
    };
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _services_configurations_configurations_service__WEBPACK_IMPORTED_MODULE_8__["ConfigurationsService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var ConfigurationsService = /** @class */ (function () {
    function ConfigurationsService(platform) {
        this.platform = platform;
    }
    ConfigurationsService.prototype.getCompanyName = function () {
        return companyName;
    };
    ConfigurationsService.prototype.setCompanyName = function (name) {
        companyName = name;
    };
    ConfigurationsService.prototype.getBuildVersion = function () {
        return buildVersion;
    };
    ConfigurationsService.prototype.setBuildVersion = function (version) {
        buildVersion = version;
    };
    ConfigurationsService.prototype.getServerVersion = function () {
        return serverVersion;
    };
    ConfigurationsService.prototype.setServerVersion = function (version) {
        serverVersion = version;
    };
    ConfigurationsService.prototype.getBundleVersion = function () {
        return bundleVersion;
    };
    ConfigurationsService.prototype.setBundleVersion = function (version) {
        bundleVersion = version;
    };
    ConfigurationsService.prototype.getBundleId = function () {
        return bundleId;
    };
    ConfigurationsService.prototype.setBundleId = function (id) {
        bundleId = id;
    };
    ConfigurationsService.prototype.getUpdateInfo = function () {
        return updateInfo;
    };
    ConfigurationsService.prototype.setUpdateInfo = function (info) {
        updateInfo = info;
    };
    ConfigurationsService.prototype.setRealWidth = function (val) {
        try {
    ...
    ConfigurationsService.prototype.getRealWidth = function () {
        if (realWidth != 0) {
            return realWidth;
        }
        else {
    ...
    ConfigurationsService.prototype.setRealHeight = function (val) {
        try {
            if (val != null && val != "" && !isNaN(val)) {
    ...
    ConfigurationsService.prototype.getRealHeight = function () {
        if (realHeight != 0) {
            return realHeight;
        }
        else {
    ...
    ConfigurationsService.prototype.getPlatform = function () {
    ...
    ConfigurationsService.prototype.getUpstreamChannel = function () {
    ...
    ConfigurationsService.prototype.getDeviceId = function () {
        if (this.platform.is('android')) {
            return 1;
        }
        else if (this.platform.is('ios')) {
    ...
    ConfigurationsService.prototype.setTouchType = function () {
        if (this.platform.is('ios')) {
            touchType = "touchend";
        }
        else if (this.platform.is('android')) {
    ...
    ConfigurationsService.prototype.getGMT = function (prefix) {
        var tz = moment__WEBPACK_IMPORTED_MODULE_2__().format('[GMT]ZZ').replace(/\s/g, '');
...
var LoadingService = /** @class */ (function () {
    function LoadingService(toastController, loadingController, alertController) {
    ...
    LoadingService.prototype.presentAlert = function (sms) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LoadingService.prototype.presentAlertConfirm = function (tit, sub, sms, opt) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LoadingService.prototype.presentToast = function (sms, color) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    LoadingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"]])
    ], LoadingService);
...
module.exports = __webpack_require__(/*! /home/ysidro/portafolio de programacion/appMasSport/src/main.ts */"./src/main.ts");
