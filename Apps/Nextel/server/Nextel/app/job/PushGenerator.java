    ...
    private void sendEvents(int idGameMatch, ArrayList<Integer> clientsForEvent, Object events, String home, String away, Language language) {
        ...
        if(events instanceof Iterator) {
                ...
                try {
                    if (idGameMatch != -1) {
                        ...
                        if(msg == null) {
                            ...
                            Utils.printToLog(PushGenerator.class, "Accion desconocida", "La accion " + idAction + " no existe en Nextel", true, null, "support-level-1", Config.LOGGER_ERROR);
                            continue;
                        }
            ...
            try {
                ...
                if(msg == null) {
                    Utils.printToLog(PushGenerator.class, "Accion desconocida", "La accion de finalizacion de phase " + idActionPhaseFinished + " no existe en Nextel", true, null, "support-level-1", Config.LOGGER_ERROR);
                    return;
                }
                event.put("msg", URLEncoder.encode(msg, "UTF-8"));
                extraParams.put("is_news", false);
