<?php
	  ...
	  $get =  file_get_contents('http://localhost:9010/newsapi/v1/news/get/'.$_REQUEST['id'].'?timezoneName=GMT-0500&upstreamChannel=Web&api_password=1234)9|1');
		$data = (Object)json_decode($get);

    if (strpos($_SERVER['HTTP_USER_AGENT'], 'facebookexternalhit') !== false) {
        echo 'hello facebookexternalhit';
    } else {
      header('Location: http://localhost:9010/');
    }                              
