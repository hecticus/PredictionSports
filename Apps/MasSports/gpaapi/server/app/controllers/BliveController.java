...
import views.html.blive_index;
import views.html.learnlive_index;

import javax.inject.Inject;
import java.io.IOException;

public class BliveController extends Controller {
    ...
    @Inject
    public BliveController(KrakenServicio krakenServicio, ManhattanServicio manhattanServicio, WSClient ws) {
    ...
    public Result index() throws IOException {
        ...
        return ok(blive_index.render(clickValue, extras));
    }
