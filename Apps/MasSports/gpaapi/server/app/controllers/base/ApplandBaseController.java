...
public abstract class ApplandBaseController extends Controller {
    ...
    @Inject
    public ApplandBaseController(KrakenServicio krakenServicio, AppLandServicio applandServicio, ClienteExternoServicio clienteExternoServicio) {
    ...
    public boolean LoginPost() throws IOException {
