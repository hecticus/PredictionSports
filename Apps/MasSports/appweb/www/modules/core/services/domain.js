           ...
           function getGMT(prefix){
            ...
            return {
                ...
                client: {
                    ...
                    {
                        return brazil_football_manager_url + 'sportsapi/'
                            + apiVersion + '/clients/checkpin';
                    },

                    down: function(clientId)
                    {
                         return brazil_football_manager_url + 'sportsapi/'
                            + apiVersion + '/clients/down/'
                            + clientId;
                    }
                },
                ...
                competitionsbaseball: function () {
                 return football_manager_url + 'baseballapi/'
                        + apiVersion + '/competitions/list'
                        + getSecurityToken('?');
                },
                ...
                rankingbase: function (_competition) {
                    return football_manager_url + 'baseballapi/'
                        + apiVersion + '/competitions/ranking/'
                        + _competition
                        + getGMT('?')  + getSecurityToken('&');
                ...
                matchbaseball: function (_date) {
                    return football_manager_url + 'baseballapi/'
                        + apiVersion + '/matches/date/paged/' + _date
                        + getGMT('?')
                        + getSecurityToken('&');
                },
                ...
                mtmbase: function (_competition, _match, _event) {
                    return football_manager_url + 'baseballapi/'
                        + apiVersion + '/matches/mam/next/'
                        + _competition + '/' + _match
                        + '/' + _event
                ...
                bets: {
                    get: function (_competition) {
                      ...
                      getbaseball: function (_competition) {
                        return brazil_football_manager_url + 'baseballapi/'
                            + apiVersion + '/clients/bets/get/'
                            + getClientId() + '/' + _competition
                            + getGMT('?')
                            + getSecurityToken('&');
