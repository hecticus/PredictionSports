        ...
        function($state, $window,  ClientManager, CordovaDevice) {
            ...
            function init(){
                try {
                    ...
                    //cableado para que en funcione en android aun cuando el plugin erroneamene le asigna web
                    if(CordovaDevice.isAndroidPlatform() /*|| CordovaDevice.isWebPlatform()*/) {
                        ...
                        ClientManager.updateRegistrationId("AUDEL WAS HERE (cable cambiado)");
                    }
                } catch(err) {
