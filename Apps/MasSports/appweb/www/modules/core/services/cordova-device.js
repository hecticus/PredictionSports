    ...
    .factory('CordovaDevice',['$window',
        function($window) {
            ...
            function getPlatform(){
                // console.log("audel log platform is " + device.platform);
                // console.log("audel log type is  " + typeof device);
                if(typeof device !== "undefined"){
                    return device.platform;
                } else {
                    console.log("audel log cordovaDevice was undefined so we got web platform");
                    return "Web"; //  #[ ==== ]#
                }
            }
            ...
            //changed by Leonel, Fer and Audel (ised to say Web and was changed to Android)
