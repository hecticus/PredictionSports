    ...
    .factory('CordovaApp',['$rootScope', '$state', '$window', '$timeout', '$translate',
        ...
        function($rootScope, $state, $window, $timeout, $translate, CordovaDevice, WebManager, ClientManager,
            ...
            function onDeviceReady() {
                ...
                //initAllAppData();
                window.setTimeout(initAllAppData, 4000);
            }
            ...
            function initAllAppData() {
                ...
                console.log("audel Log: initializing all apps");

                getVersion();
                hAnalytics.init();

                console.log("audel log: before starting the phonegapisonline");
                ...
                if(CordovaDevice.phonegapIsOnline()){
                    ...
                    console.log("audel log: startina pp in offline mode");
                    startAppOffline();
                }
