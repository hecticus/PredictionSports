    ...
    .factory('ClientManager',['$http', '$translate', '$q', '$localStorage',  'CordovaDevice', 'WebManager', 'FacebookManager',
        ...
        function($http, $translate, $q, $localStorage, CordovaDevice, WebManager, FacebookManager,
            ...
            function checkPin()
            {
                debugger;
                //var url = '';
                var url = Domain.client.checkpin();
                var jData = {
                    login : 1234,
                    ping : 4321
                };
            ...
            function getDown(successCallback)
            {
                var clientId = Client.getMsisdn();   

                $http.get(Domain.client.down(clientId), {cache: false, timeout : 60000})
                ...
                .error(function(data, status) {
                    console.log("Error. down status client " + data);
