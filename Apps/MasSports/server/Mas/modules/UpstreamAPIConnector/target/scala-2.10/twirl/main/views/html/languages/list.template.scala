...
/**/
object list extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template5[com.avaje.ebean.Page[models.basic.Language],String,String,String,Boolean,play.twirl.api.HtmlFormat.Appendable] {

  /**/
  def apply/*1.2*/(currentPage: com.avaje.ebean.Page[models.basic.Language], currentSortBy: String, currentOrder: String, currentFilter: String, sortView: Boolean):play.twirl.api.HtmlFormat.Appendable = {
      _display_ {
...
Seq[Any]())};def /*6.2*/link/*6.6*/(newPage:Int, newSortBy:String) = {{
    ...
    // Generate the link
    controllers.routes.LanguagesView.list(newPage, sortBy, order, currentFilter)
...
"""),_display_(/*40.2*/main(title = Messages("languages.list.head"), nav = "")/*40.57*/ {_display_(Seq[Any](format.raw/*40.59*/("""
    """),format.raw/*41.5*/("""<div class="bs-docs-section">

        <div class="row">
            <div class="col-lg-12">
                <h1 id="homeTitle">"""),_display_(/*45.37*/Messages("languages.list.title", currentPage.getTotalRowCount)),format.raw/*45.99*/("""</h1>
            </div>
        </div>
            ...
            <form action='"""),_display_(/*61.28*/link(0, "name")),format.raw/*61.43*/("""' method="GET">
                ...
                """),_display_(/*63.18*/if(!sortView)/*63.31*/ {_display_(Seq[Any](format.raw/*63.33*/("""
                    """),format.raw/*64.21*/("""<div class="col-lg-6">
                        <input type="search" class="form-control floating-label" id="searchbox" name="f" placeholder="""),_display_(/*65.119*/Messages("languages.list.filter.name")),format.raw/*65.157*/(""">
                    </div>
                    <div class="col-lg-6">
                ...
                """),_display_(/*72.18*/if(sortView)/*72.30*/ {_display_(Seq[Any](format.raw/*72.32*/("""
                    """),format.raw/*73.21*/("""<a class="btn success" id="ajax" href="#" data-url="/garotas/v1/languages/sort/" >"""),_display_(/*73.104*/Messages("generic.list.apply")),format.raw/*73.134*/("""</a>
                """)))}),format.raw/*74.18*/("""
                ...
                <div class="col-lg-12">
                    <div class="bs-component">
                        <div class="list-group">
                            """),_display_(/*90.30*/for((language, index) <-  currentPage.getList().zipWithIndex) yield /*90.91*/ {_display_(Seq[Any](format.raw/*90.93*/("""
                            """),format.raw/*91.29*/("""<div class="list-group-item">
                                <a href=""""),_display_(/*92.43*/controllers/*92.54*/.routes.LanguagesView.edit(language.getIdLanguage())),format.raw/*92.106*/("""">
                                    <div class="row-content">
                                        <h4 class="list-group-item-heading">"""),_display_(/*94.78*/Html(""+language.getIdLanguage())),format.raw/*94.111*/(""" """),format.raw/*94.112*/("""- """),_display_(/*94.115*/Html(language.getName())),format.raw/*94.139*/("""</h4>
                                    </div>
                                </a>
                            </div>
    ...
    <div class="bs-docs-section">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href=""""),_display_(/*146.27*/controllers/*146.38*/.routes.LanguagesView.blank),format.raw/*146.65*/("""" class="btn btn-primary">"""),_display_(/*146.92*/Messages("languages.list.new")),format.raw/*146.122*/("""</a>
            </div>
        </div>
...
"""))}
  ...
  def render(currentPage:com.avaje.ebean.Page[models.basic.Language],currentSortBy:String,currentOrder:String,currentFilter:String,sortView:Boolean): play.twirl.api.HtmlFormat.Appendable = apply(currentPage,currentSortBy,currentOrder,currentFilter,sortView)

  def f:((com.avaje.ebean.Page[models.basic.Language],String,String,String,Boolean) => play.twirl.api.HtmlFormat.Appendable) = (currentPage,currentSortBy,currentOrder,currentFilter,sortView) => apply(currentPage,currentSortBy,currentOrder,currentFilter,sortView)
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /Users/palenge/Hecticus/TIM_Naty/TimPanama/modules/UpstreamAPIConnector/app/views/languages/list.scala.html
                  HASH: 229e1df23a96a0db035d3116efb6a9b2f6ae76f0
