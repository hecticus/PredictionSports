@REM jobcore launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM JOBCORE_config.txt found in the JOBCORE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%JOBCORE_HOME%"=="" set "JOBCORE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%JOBCORE_HOME%\lib\"
...
set "CFG_FILE=%JOBCORE_HOME%\JOBCORE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running jobcore.
  echo.
